...
| --- | --- | --- | --- |
| `tutorials/` | Tutorial starter models used by the docs walkthroughs | `uv run qsol solve examples/tutorials/first_program.qsol --instance examples/tutorials/first_program.instance.json --runtime local-dimod --out outdir/first_program --runtime-option sampler=exact` | [`examples/tutorials/README.md`](tutorials/README.md) |
